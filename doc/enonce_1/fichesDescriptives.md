...
## Dessiner univers initial :

### Sommaire d'identification :

	Résumé           : L'utilisateur dessine un univers initial
	Acteurs          : Utilisateur
	Auteur           : Groupe
	Date de création : 05.04.2022
	Version          : 1.0
...
#### Pré conditions : 
	Aucune
#### Scénario nominal : 
	1. L'utilisateur dessine un univers initial pour la simulation
	2. Le système est prêt à générer l'univers dessiné
#### Enchaînements alternatifs : 
	-
#### Post conditions : 
	-
#### Enchaînements d'exception : 
	E1 : L'utilisateur dessine un univers impossible à simuler
	- Le système informe l'utilisateur des problèmes concernant l'univers à simuler
#### Post conditions : 
...
## Créer élément dans une case de damier :
